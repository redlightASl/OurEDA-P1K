...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set SYS_GLOBAL_RESET [ create_bd_port -dir O -type rst SYS_GLOBAL_RESET ]

  # Create instance: sys_ps7_reset, and set properties
  set sys_ps7_reset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 sys_ps7_reset ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS { \
     ...
     0#Enet 0 \
     0#Enet 0 \
     0#SD 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet \
     0#SD 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet \
     0#SD 0#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet \
     0#USB 0#SD \
     0#USB 0#SD \
     ...
     0#USB 0#SD \
     0#USB 0#SD \
     1#UART 1#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#Enet \
     SD 0#Quad \
     SPI Flash#unassigned#UART \
     SPI Flash#unassigned#UART \
     SPI Flash#unassigned#UART \
     SPI Flash#unassigned#UART \
     SPI Flash#unassigned#UART \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins sys_ps7_reset/slowest_sync_clk] [get_bd_pins zynq_ps/FCLK_CLK0] [get_bd_pins zynq_ps/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_ports SYS_GLOBAL_RESET] [get_bd_pins sys_ps7_reset/ext_reset_in] [get_bd_pins zynq_ps/FCLK_RESET0_N]
