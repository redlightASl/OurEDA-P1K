...
HD_PWD='F:/Git_repository/OurEDA/OurEDA-P1K/Fpga/OurEDA-P1K_zynq/OurEDA-P1K_zynq.runs/design_main_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_main_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_main_proc_sys_reset_0_0.tcl
