...
#define LED_S00_AXI_SLV_REG1_OFFSET 4
#define LED_S00_AXI_SLV_REG2_OFFSET 8
#define LED_S00_AXI_SLV_REG3_OFFSET 12
 ...
 *
 * @param   BaseAddress is the base address of the LEDdevice.
 ...
 * @note
 * C-style signature:
 * 	void LED_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	u32 LED_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
 ...
 *
 */
XStatus LED_Reg_SelfTest(void * baseaddr_p);
